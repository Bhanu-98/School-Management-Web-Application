...
<html>
	...
	<div class="whole">
		...
		<img src="img/banner.jpg" style="margin-left:180px;" class="sha">
			...
			<div id="section">
				...
				<div class="content">
					...
					<p class="para">
						VSR Model School is one such pioneer in the field of education – that brings in a fresh and unique approach to the schooling with the belief that education today, must serve the interests of the individual, nation and mankind.High academic standards are symbolic of our ideology and commitment to academic excellence.
					</p>
				</div>
