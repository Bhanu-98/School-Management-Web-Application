					...
					<?php
						if(isset($_POST["submit"]))
						{
							$edate=$_POST["da"].'-'.$_POST["mo"].'-'.$_POST["ye"];
							    $s="insert into st_leaves(ID,Student_Name,Date_of_Request,Reason,Contact) values('{$_SESSION["ID"]}','{$_SESSION["NAME"]}','{$edate}','{$_POST["rsn"]}','{$_POST["pho"]}')";
								$sq="insert into st_leave_requests(ID,Student_Name,Date_of_Request,Reason,Contact,status) values('{$_SESSION["ID"]}','{$_SESSION["NAME"]}','{$edate}','{$_POST["rsn"]}','{$_POST["pho"]}','NA')";
								$db->query($s);
								if($db->query($sq))
								{
